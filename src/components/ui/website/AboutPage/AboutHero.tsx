      ...
      <div className="px-6 text-start">
        ...
        <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
          <p className="text-justify">
            We built Investors Hub to solve a critical gap in the South African
            property market: the need for a discreet, professional platform
            where high-value deals can happen without public scrutiny.
          </p>
        </div>
      </div>
      <div className="">
