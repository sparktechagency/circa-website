  ...
  return (
    <div className="mb-14">
      <div className="text-center mb-16 pt-32">
        ...
        <p className="text-gray-400 text-lg">Last Updated: January 18, 2026</p>
      </div>
      <div className="bg-[#111111] border border-[#D4AF37]/10 rounded-xl p-8 md:p-12 prose prose-invert max-w-none">
        <div className="mb-12">
          <h2 className="text-2xl  text-white mb-4 flex items-center gap-3">
            <span className="w-8 h-8 rounded-full bg-[#D4AF37]/10 flex items-center justify-center text-[#D4AF37] text-sm font-bold">
              1
            </span>
            Introduction
          </h2>
          <p className="text-gray-400 leading-relaxed">
            At Investors Hub ("we," "our," or "us"), we respect your privacy and
        ...
        <div className="mb-12">
          ...
          <ul className="space-y-3 text-gray-400 list-disc pl-6">
            ...
            <li>
              <strong className="text-white">Financial Data:</strong> includes
              bank account and payment card details (processed securely by our
              payment providers).
            </li>
            <li>
              <strong className="text-white">Transaction Data:</strong> includes
          ...
          <div className="grid gap-4 mt-6">
            <div className="bg-[#0A0A0A] p-6 rounded-lg border border-[#333]">
              ...
              <p className="text-sm text-gray-400">
                To provide and manage your account, verify your identity, and
                facilitate anonymous communication with other users.
              </p>
            </div>
            <div className="bg-[#0A0A0A] p-6 rounded-lg border border-[#333]">
              <h3 className="text-white font-medium mb-2">Platform Security</h3>
              <p className="text-sm text-gray-400">
                To detect and prevent fraud, abuse, and security incidents. Your
                anonymity on the platform is maintained, but we must verify your
            ...
            <div className="bg-[#0A0A0A] p-6 rounded-lg border border-[#333]">
              ...
              <p className="text-sm text-gray-400">
                To send you updates, newsletters (if subscribed), and important
        ...
        <div>
          ...
          <p className="text-gray-400 leading-relaxed">
            ...
            <a
              href="mailto:privacy@investorshub.co.za"
              className="text-[#D4AF37] hover:underline ml-1"
            >
              privacy@investorshub.co.za
            </a>
            .
          </p>
        </div>
