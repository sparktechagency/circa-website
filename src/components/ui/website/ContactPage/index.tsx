      ...
      <section className="bg-[#111111] py-28 md:py-36 border-b border-[#D4AF37]/10">
        <div className="max-w-4xl mx-auto px-6 text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Have questions about membership, listing a property, or our
            verification process? Our team is ready to assist.
          </p>
        </div>
        <Container>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:info@investorshub.co.za"
                        className="text-[#D4AF37] hover:underline block"
                      >
                        info@investorshub.co.za
                      </a>
                      <p className="text-gray-400 mt-2 mb-1">Support:</p>
                      <a
                        href="mailto:support@investorshub.co.za"
                        className="text-[#D4AF37] hover:underline block"
                      >
                        support@investorshub.co.za
                      </a>
                    </div>
                  </div>
