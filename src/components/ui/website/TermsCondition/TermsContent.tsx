    ...
    <div className="bg-[#111111] border border-primary/10 rounded-xl p-8 md:p-12 prose prose-invert max-w-none mb-14">
      <div className="mb-8">
        ...
        <p className="text-gray-400 leading-relaxed">
          By accessing or using the Investors Hub platform, you agree to be
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2 text-gray-400">
          ...
          <li>
            Pass our verification process (KYC/FICA) if required for specific
            access levels.
          </li>
          <li>
      ...
      <div className="mb-8">
        <h2 className="text-2xl  text-white mb-4">3. User Conduct</h2>
        <p className="text-gray-400 leading-relaxed mb-4">
          You agree not to engage in any of the following prohibited activities:
        </p>
        <ul className="list-disc pl-6 space-y-2 text-gray-400">
          <li>
            Using the platform for any illegal purpose or in violation of any
            local, state, national, or international law.
          </li>
          <li>Harassing, threatening, or defrauding other users.</li>
          <li>
            Attempting to circumvent the anonymity features of the platform
            (e.g., soliciting direct contact information in initial messages).
          </li>
      ...
      <div className="mb-8">
        <h2 className="text-2xl  text-white mb-4">4. Membership & Fees</h2>
        <p className="text-gray-400 leading-relaxed">
          Investors Hub offers paid membership tiers. Fees are billed in advance
          on a monthly or annual basis and are non-refundable unless otherwise
          stated. We reserve the right to change our fees upon notice to you.
        </p>
      </div>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400 leading-relaxed">
          ...
          owned by Investors Hub and are protected by international copyright,
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400 leading-relaxed">
          ...
          Investors Hub makes no representation or warranty of any kind, express
          or implied, regarding the accuracy, adequacy, validity, reliability,
          availability, or completeness of any information on the site. We do
          not act as an estate agent or financial advisor.
        </p>
      </div>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400 leading-relaxed">
          In no event shall Investors Hub, nor its directors, employees,
